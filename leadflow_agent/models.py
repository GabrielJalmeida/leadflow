...
class ResearchReport:
    ...
    investigation_extractions: int = 0
    ...
    discovery_unique_candidates: int = 0
    discovery_prequalified: int = 0
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "investigation_extractions": self.investigation_extractions,
            ...
            "discovery_unique_candidates": self.discovery_unique_candidates,
            "discovery_prequalified": self.discovery_prequalified,
