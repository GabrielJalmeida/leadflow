...
**Next milestone:** `Functional Frontend v0`
...
- [Why LeadFlow is different](#why-leadflow-is-different)
...
LeadFlow is currently a **CLI-first alpha**. The **Backend Intelligence Core** checkpoint is complete and published as **v0.2.0-alpha.1**. The next phase is the first functional GUI.
...
The first public backend milestone is complete. Development is now moving into a deliberately simple functional frontend.
